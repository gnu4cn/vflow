"""
Django settings for senscomm project.
...
AUTH_LDAP_USER_FLAGS_BY_GROUP = {
        ...
        "is_staff": "CN=Users,CN=Builtin,{0}".format(AUTH_LDAP_BASE_DN),
        }
...
SECRET_KEY = 'django-insecure-azg(-8eyf@9!a*q-wz+8aw)l9%=7s#*8b+*1-tq6kncc0=xbvm'
